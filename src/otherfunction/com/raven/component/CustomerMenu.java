...
public class CustomerMenu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("0","1", "Dịch Vụ", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("1","2", "Nạp Tiền", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2","3", "Đổi Quà", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3","4", "Thông Tin Khách Hàng", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4","5", "Lịch Sử Sử Dụng", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("","9", "More", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5","10", "Logout", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("","", "", Model_Menu.MenuType.EMPTY));
    }
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#AF6E4D"), 0, getHeight(), Color.decode("#592720"));
        g2.setPaint(g);

...
public class ReceptionMenu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("0","1", "Tạo Khách Hàng Mới", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("1","2", "Đổi Quà", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2","3", "Giao Dịch", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3","4", "Ca Làm", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4","8", "Thông Tin Nhân Viên", Model_Menu.MenuType.MENU));

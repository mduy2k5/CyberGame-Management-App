...
public class SecurityMenu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("0","1", "Báo Cáo Sự Cố", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("1","2", "Theo Dõi Camera", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3","8", "Thông Tin Nhân Viên", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("4","10", "Logout", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("","", "", Model_Menu.MenuType.EMPTY));
    }

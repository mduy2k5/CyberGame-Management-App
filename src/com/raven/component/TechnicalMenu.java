...
public class TechnicalMenu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("0","1", "Replace Device", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("1","2", "Add Device to Computer", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2","3", "Update Device Status", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3","7", "Update Area Status", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4","4", "Working Hours", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5","8", "Information", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("","9", "More", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6","10", "Logout", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("","", "", Model_Menu.MenuType.EMPTY));
    }

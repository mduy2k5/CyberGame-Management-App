...
public class ServiceMenu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("0","1", "Phục vụ", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("1","2", "Ca làm", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2","3", "Thông Tin Nhân Viên", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("","9", "More", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3","10", "Logout", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("","", "", Model_Menu.MenuType.EMPTY));
    }

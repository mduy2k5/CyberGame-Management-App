...
public class AreaType_Manager extends javax.swing.JPanel {
    public void loadForm5_1(){
            ...
            for (AreaTypeClass areatype : areatypes) {
                String malkv = areatype.getMaLKV();
                String tenlkv = areatype.getTenLoai();
                double giatien = areatype.getGiaTien();
                int somaytoida = areatype.getSoLuongMay();
                
                model.addRow(new Object[]{malkv, tenlkv, giatien, somaytoida});
                
            }
 
    }
    public AreaType_Manager() {
        initComponents();
                ArrayList<String> result = Statistic.thongKeLoaiKhuVuc();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh Sách Loại Khu Vực");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã LKV", "Tên LKV", "Giá Tiền", "Số Máy Tối Đa"
            }
        ) {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        Insert insertForm = new Insert((UpdatableEntity) areatype, this::loadForm5_1);
        insertForm.setVisible(true);
    }//GEN-LAST:event_btnInsertActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        DeleteUtil.deleteRecord(table, "LOAI_KHU_VUC", "MALKV");
        loadForm5_1();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        AreaTypeClass areatype = new AreaTypeClass();
        areatype.setMaLKV(table.getValueAt(selectedRow, 0).toString());
        areatype.setTenLoai(table.getValueAt(selectedRow, 1).toString());
        areatype.setGiaTien(Double.parseDouble(table.getValueAt(selectedRow, 2).toString()));
        areatype.setSoLuongMay(Integer.parseInt(table.getValueAt(selectedRow, 3).toString()));

        // Mở form cập nhật tổng quát
        Update updateForm = new Update((UpdatableEntity) areatype, this::loadForm5_1); // constructor mới

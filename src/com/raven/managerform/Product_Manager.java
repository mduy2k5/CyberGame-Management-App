...
public class Product_Manager extends javax.swing.JPanel {
    public void loadForm7(){
            ...
            for (ProductClass product : products) {
                ...
                int sodiemtl = product.getSoDiemTichLuy();
                Double dongia = product.getDonGiaBQ();
                int sltonkho = product.getSoLuongTK();
                String url = product.getUrl();

                model.addRow(new Object[]{masp, tensp, loaisp, dvt, sodiemtl, dongia, sltonkho, url});
    ...
    public Product_Manager() {
        initComponents();
                ArrayList<String> result = Statistic.thongKeSanPham();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Tên SP", "Loại SP", "ĐVT", "Số Điểm", "Đơn Giá", "SL Tồn Kho", "URL"
            }
        ) {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        Insert insertForm = new Insert((UpdatableEntity) product, this::loadForm7);
        insertForm.setVisible(true);
    }//GEN-LAST:event_btnInsertActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        DeleteUtil.deleteRecord(table, "SAN_PHAM", "MASP");
        loadForm7();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        ProductClass product = new ProductClass();
        product.setMaSP(table.getValueAt(selectedRow, 0).toString());
        product.setTenSP(table.getValueAt(selectedRow, 1).toString());
        product.setLoaiSP(table.getValueAt(selectedRow, 2).toString());
        product.setDvt(table.getValueAt(selectedRow, 3).toString());
        product.setSoDiemTichLuy(Integer.parseInt(table.getValueAt(selectedRow, 4).toString()));
        product.setDonGiaBQ(Double.parseDouble(table.getValueAt(selectedRow, 5).toString()));
        product.setUrl(table.getValueAt(selectedRow, 6).toString());

        // Mở form cập nhật tổng quát
        Update updateForm = new Update((UpdatableEntity) product, this::loadForm7); // constructor mới

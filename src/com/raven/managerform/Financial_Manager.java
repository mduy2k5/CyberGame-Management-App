...
public class Financial_Manager extends javax.swing.JPanel {
    public void loadForm2(){
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            model.setRowCount(0); // Xóa dữ liệu cũ

            ArrayList<PaymentClass> payments = Payment.SelectPayment(); // Gọi hàm từ lớp Area

            for (PaymentClass payment : payments) {
                String maphieu = payment.getMaPhieu();
                String makh = payment.getMaKH();
                int tongsodv = payment.getTongSoDV();
                String trangthai = payment.getTrangThai();
                double tongtien = payment.getTongTien();
                String thoigian = payment.getCreatedAt().toString();
                model.addRow(new Object[]{maphieu, makh, tongsodv, tongtien, trangthai,thoigian});
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh Sách Tài Chính");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Phiếu", "Mã Khách Hàng", "Tổng Số Dịch Vụ", "Tổng Tiền", "Trạng Thái", "Thời Gian"
            }
        ) {

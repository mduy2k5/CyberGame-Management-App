...
public class EmployeeType_Manager extends javax.swing.JPanel {
    public void loadForm3_5(){
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            model.setRowCount(0); // Xóa dữ liệu cũ

            ArrayList<EmployeeTypeClass> employeetypes = EmployeeWType.SelectEWType();

            for (EmployeeTypeClass employeetype : employeetypes) {
                String maloainv = employeetype.getMaLoaiNV();
                String tenloainv = employeetype.getTenLoaiNV();
                int mucluong = employeetype.getMucLuong();

                model.addRow(new Object[]{maloainv, tenloainv, mucluong});
            }
 
    }
    public EmployeeType_Manager() {
        initComponents();
                ArrayList<String> result = Statistic.thongKeLoaiNhanVien();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh Sách Loại Nhân Viên");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Loại Nhân Viên", "Tên Loại Nhân Viên", "Mức Lương"
            }
        ) {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        Insert insertForm = new Insert((UpdatableEntity) employeetype, this::loadForm3_5);
        insertForm.setVisible(true);
    }//GEN-LAST:event_btnInsertActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        DeleteUtil.deleteRecord(table, "LOAI_NHAN_VIEN", "MALNV");
        loadForm3_5();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        EmployeeTypeClass employeetype = new EmployeeTypeClass();
        employeetype.setMaLoaiNV(table.getValueAt(selectedRow, 0).toString());
        employeetype.setTenLoaiNV(table.getValueAt(selectedRow, 1).toString());
        employeetype.setMucLuong(Integer.parseInt(table.getValueAt(selectedRow, 2).toString()));
        
        // Mở form cập nhật tổng quát
        Update updateForm = new Update((UpdatableEntity) employeetype, this::loadForm3_5);

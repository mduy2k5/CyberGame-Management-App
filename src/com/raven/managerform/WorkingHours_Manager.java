...
public class WorkingHours_Manager extends javax.swing.JPanel {
    public void loadForm3_1(){
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            model.setRowCount(0); // Xóa dữ liệu cũ

            ArrayList<WorkHoursClass> workhours = WorkHours.SelectWHours();

            for (WorkHoursClass workhour : workhours) {
                String manv = workhour.getManv();
                String tennv = User.SelectUserByMANV(manv).getHoTen();
                String maca = workhour.getMaca();
                String ngaycc = workhour.getNgaycc().toString();
                String tgbd = workhour.getTgbd().toString();
                String tgkt = workhour.getTgkt().toString();
                int giolv = workhour.getWorkHours();
                int giolt = workhour.getOvertimeHours();
                String trangthai = workhour.getTrangthai();
                
                model.addRow(new Object[]{manv, tennv, maca, ngaycc, tgbd, tgkt, giolv, giolt, trangthai});
            }
 
    }
    public WorkingHours_Manager() {
        initComponents();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã NV", "Tên NV", "Mã Ca", "Ngày CC", "Thời Gian BĐ", "Thời Gian KT", "Giờ Làm Việc", "Giờ Làm Thêm", "Trạng Thái"
            }
        ) {

...
public class ReplaceDevice_Manager extends javax.swing.JPanel {
    
    public void loadForm4_1(){
            DefaultTableModel model = (DefaultTableModel) table.getModel();
            model.setRowCount(0); // Xóa dữ liệu cũ

            ArrayList<ReplaceDeviceClass> rdevices = ReplaceDevice.SelectRDevice();

            for (ReplaceDeviceClass rdevice : rdevices) {
                model.addRow(new Object[]{rdevice.getMaTTTB(), rdevice.getMaTB(), rdevice.getMaTBThayThe(),rdevice.getMaNV(), rdevice.getTrangThai()});
            }
 
    }
    public ReplaceDevice_Manager() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh Sách Thay Thế Thiết Bị");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã TTTB", "Mã TB Hỏng", "Mã TB TT", "MaNV", "Trạng Thái"
            }
        ) {

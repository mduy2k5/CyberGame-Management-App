...
public class WorkingHours_Service extends javax.swing.JPanel {
    private String manv;
    ...
    public WorkingHours_Service(String manv) {
        this.manv = manv;
        initComponents();
        //  add row table
    ...
    private void btnFinishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinishActionPerformed
        int confirm = JOptionPane.showConfirmDialog(null, "Bạn có chắc muốn kết thúc", "Confirm", JOptionPane.YES_NO_OPTION);
